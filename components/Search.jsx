...
const Search = () => {
    ...
    useEffect(() =>{
        ...
        const fetchData = async () => {
            ...
            const url_local = `${process.env.NEXT_PUBLIC_LOCAL_URL}/api/search`
            const url_prod = `${process.env.NEXT_PUBLIC_API_ROOT}/api/search`

			const { data } = await axios.get(url_local || url_prod, {
				params: {
					title: queryText,
				},
			})
